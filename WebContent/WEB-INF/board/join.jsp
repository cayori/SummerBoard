...
<div class="wrapper">
	...
	<form action="join.do" method="post" onsubmit="return passwordCheck()">
		<fieldset>
			...
			<span class="error">
				<form:errors path="memberModel.userId" /><br>
			</span>
			<label for="userPw">&nbsp;비밀번호 : </label>
			<input type="password" id="userPw" name="userPw" class="loginInput" />
			<span class="error">
				<form:errors path="memberModel.userPw" /><br>
			</span>
			<label for="userPwCheck">&nbsp;비밀번호 확인 : </label>
			<input type="password" id="userPwCheck" name="userPwCheck" class="loginInput" />
			<span class="error">
				<form:errors path="memberModel.userPwCheck" /><br>
			</span>
			<label for="userName">&nbsp;회원이름 : </label>
			<input type="text" id="userName" name="userName" class="loginInput" />
			<span class="error">
				<form:errors path="memberModel.userName" /><br><br>
			</span>
